...
const OpenOffer = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      setOpen(false);
      setEditingRow(null);
      setForm({ sno: "", title: "", page: "open-offer" });
      setNewFile(null);
    } catch (err) {
      console.error(err);
  ...
  return (
    <>
      ...
      <div className="fixed top-0 p-4 bg-gray-100 border-b w-full flex flex-wrap gap-2 z-10">
        ...
        <span className="text-black">Open Offer</span>
      </div>

      {/* Table */}
      <div className="p-4 mt-14 w-full">
        <div className="flex justify-between items-center mb-3">
          <h2 className="font-semibold text-lg">Open Offer</h2>
          <button
            onClick={openAdd}
          ...
          <div className="relative">
            ...
            >
              <h3 className="text-lg font-semibold mb-4">
                {editingRow ? "Edit" : "Add"} Open Offer
              </h3>
